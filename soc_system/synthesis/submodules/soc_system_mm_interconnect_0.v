...
module soc_system_mm_interconnect_0 (
	...
	wire  [114:0] iceboardcontrol_0_avalon_slave_0_agent_rf_source_data;                // ICEboardControl_0_avalon_slave_0_agent:rf_source_data -> ICEboardControl_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [114:0] iceboardcontrol_0_avalon_slave_0_agent_rsp_fifo_out_data;             // ICEboardControl_0_avalon_slave_0_agent_rsp_fifo:out_data -> ICEboardControl_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [113:0] iceboardcontrol_0_avalon_slave_0_agent_rp_data;                       // ICEboardControl_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [113:0] led_s1_agent_rp_data;                                                 // LED_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [113:0] cmd_mux_001_src_data;                                                 // cmd_mux_001:src_data -> ICEboardControl_0_avalon_slave_0_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                // ICEboardControl_0_avalon_slave_0_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                              // cmd_mux_001:src_channel -> ICEboardControl_0_avalon_slave_0_burst_adapter:sink0_channel
	...
	wire  [113:0] iceboardcontrol_0_avalon_slave_0_burst_adapter_source0_data;          // ICEboardControl_0_avalon_slave_0_burst_adapter:source0_data -> ICEboardControl_0_avalon_slave_0_agent:cp_data
	...
	wire    [3:0] iceboardcontrol_0_avalon_slave_0_burst_adapter_source0_channel;       // ICEboardControl_0_avalon_slave_0_burst_adapter:source0_channel -> ICEboardControl_0_avalon_slave_0_agent:cp_channel
	...
	wire    [3:0] cmd_mux_002_src_channel;                                              // cmd_mux_002:src_channel -> sysid_qsys_control_slave_burst_adapter:sink0_channel
	...
	wire  [113:0] cmd_mux_003_src_data;                                                 // cmd_mux_003:src_data -> LED_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                // LED_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                              // cmd_mux_003:src_channel -> LED_s1_burst_adapter:sink0_channel
	...
	wire    [3:0] led_s1_burst_adapter_source0_channel;                                 // LED_s1_burst_adapter:source0_channel -> LED_s1_agent:cp_channel
