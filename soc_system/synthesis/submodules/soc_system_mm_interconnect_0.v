...
module soc_system_mm_interconnect_0 (
	...
	wire  [116:0] icebuscontrol_6_avalon_slave_0_agent_rf_source_data;                // iCEbusControl_6_avalon_slave_0_agent:rf_source_data -> iCEbusControl_6_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [116:0] icebuscontrol_6_avalon_slave_0_agent_rsp_fifo_out_data;             // iCEbusControl_6_avalon_slave_0_agent_rsp_fifo:out_data -> iCEbusControl_6_avalon_slave_0_agent:rf_sink_data
	...
	wire  [116:0] power_sense_s1_agent_rf_source_data;                                // POWER_SENSE_s1_agent:rf_source_data -> POWER_SENSE_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] power_sense_s1_agent_rsp_fifo_out_data;                             // POWER_SENSE_s1_agent_rsp_fifo:out_data -> POWER_SENSE_s1_agent:rf_sink_data
	...
	wire  [116:0] power_control_s1_agent_rf_source_data;                              // POWER_CONTROL_s1_agent:rf_source_data -> POWER_CONTROL_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] power_control_s1_agent_rsp_fifo_out_data;                           // POWER_CONTROL_s1_agent_rsp_fifo:out_data -> POWER_CONTROL_s1_agent:rf_sink_data
	...
	wire  [115:0] icebuscontrol_6_avalon_slave_0_agent_rp_data;                       // iCEbusControl_6_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [115:0] led_s1_agent_rp_data;                                               // LED_s1_agent:rp_data -> router_005:sink_data
	...
	wire          power_sense_s1_agent_rp_valid;                                      // POWER_SENSE_s1_agent:rp_valid -> router_007:sink_valid
	wire  [115:0] power_sense_s1_agent_rp_data;                                       // POWER_SENSE_s1_agent:rp_data -> router_007:sink_data
	wire          power_sense_s1_agent_rp_ready;                                      // router_007:sink_ready -> POWER_SENSE_s1_agent:rp_ready
	wire          power_sense_s1_agent_rp_startofpacket;                              // POWER_SENSE_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          power_sense_s1_agent_rp_endofpacket;                                // POWER_SENSE_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          power_control_s1_agent_rp_valid;                                    // POWER_CONTROL_s1_agent:rp_valid -> router_008:sink_valid
	wire  [115:0] power_control_s1_agent_rp_data;                                     // POWER_CONTROL_s1_agent:rp_data -> router_008:sink_data
	wire          power_control_s1_agent_rp_ready;                                    // router_008:sink_ready -> POWER_CONTROL_s1_agent:rp_ready
	wire          power_control_s1_agent_rp_startofpacket;                            // POWER_CONTROL_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          power_control_s1_agent_rp_endofpacket;                              // POWER_CONTROL_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [115:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> iCEbusControl_6_avalon_slave_0_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                              // iCEbusControl_6_avalon_slave_0_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> iCEbusControl_6_avalon_slave_0_burst_adapter:sink0_channel
	...
	wire  [115:0] icebuscontrol_6_avalon_slave_0_burst_adapter_source0_data;          // iCEbusControl_6_avalon_slave_0_burst_adapter:source0_data -> iCEbusControl_6_avalon_slave_0_agent:cp_data
	...
	wire    [6:0] icebuscontrol_6_avalon_slave_0_burst_adapter_source0_channel;       // iCEbusControl_6_avalon_slave_0_burst_adapter:source0_channel -> iCEbusControl_6_avalon_slave_0_agent:cp_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                               // cmd_mux_003:src_data -> LED_s1_burst_adapter:sink0_data
	...
	wire    [6:0] cmd_mux_004_src_channel;                                            // cmd_mux_004:src_channel -> SWITCHES_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] switches_s1_burst_adapter_source0_channel;                          // SWITCHES_s1_burst_adapter:source0_channel -> SWITCHES_s1_agent:cp_channel
	...
	wire          cmd_mux_005_src_valid;                                              // cmd_mux_005:src_valid -> POWER_SENSE_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_005_src_data;                                               // cmd_mux_005:src_data -> POWER_SENSE_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                              // POWER_SENSE_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                            // cmd_mux_005:src_channel -> POWER_SENSE_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                      // cmd_mux_005:src_startofpacket -> POWER_SENSE_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                        // cmd_mux_005:src_endofpacket -> POWER_SENSE_s1_burst_adapter:sink0_endofpacket
	wire          power_sense_s1_burst_adapter_source0_valid;                         // POWER_SENSE_s1_burst_adapter:source0_valid -> POWER_SENSE_s1_agent:cp_valid
	wire  [115:0] power_sense_s1_burst_adapter_source0_data;                          // POWER_SENSE_s1_burst_adapter:source0_data -> POWER_SENSE_s1_agent:cp_data
	wire          power_sense_s1_burst_adapter_source0_ready;                         // POWER_SENSE_s1_agent:cp_ready -> POWER_SENSE_s1_burst_adapter:source0_ready
	wire    [6:0] power_sense_s1_burst_adapter_source0_channel;                       // POWER_SENSE_s1_burst_adapter:source0_channel -> POWER_SENSE_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                              // cmd_mux_006:src_valid -> POWER_CONTROL_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_006_src_data;                                               // cmd_mux_006:src_data -> POWER_CONTROL_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                              // POWER_CONTROL_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                            // cmd_mux_006:src_channel -> POWER_CONTROL_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                      // cmd_mux_006:src_startofpacket -> POWER_CONTROL_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                        // cmd_mux_006:src_endofpacket -> POWER_CONTROL_s1_burst_adapter:sink0_endofpacket
	...
	wire  [115:0] power_control_s1_burst_adapter_source0_data;                        // POWER_CONTROL_s1_burst_adapter:source0_data -> POWER_CONTROL_s1_agent:cp_data
	...
	wire    [6:0] power_control_s1_burst_adapter_source0_channel;                     // POWER_CONTROL_s1_burst_adapter:source0_channel -> POWER_CONTROL_s1_agent:cp_channel
	...
	wire          power_sense_s1_agent_rdata_fifo_out_valid;                          // POWER_SENSE_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] power_sense_s1_agent_rdata_fifo_out_data;                           // POWER_SENSE_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          power_sense_s1_agent_rdata_fifo_out_ready;                          // avalon_st_adapter_005:in_0_ready -> POWER_SENSE_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                  // avalon_st_adapter_005:out_0_valid -> POWER_SENSE_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                   // avalon_st_adapter_005:out_0_data -> POWER_SENSE_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                  // POWER_SENSE_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                  // avalon_st_adapter_005:out_0_error -> POWER_SENSE_s1_agent:rdata_fifo_sink_error
	wire          power_control_s1_agent_rdata_fifo_out_valid;                        // POWER_CONTROL_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] power_control_s1_agent_rdata_fifo_out_data;                         // POWER_CONTROL_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          power_control_s1_agent_rdata_fifo_out_ready;                        // avalon_st_adapter_006:in_0_ready -> POWER_CONTROL_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                  // avalon_st_adapter_006:out_0_valid -> POWER_CONTROL_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                   // avalon_st_adapter_006:out_0_data -> POWER_CONTROL_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                  // POWER_CONTROL_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                  // avalon_st_adapter_006:out_0_error -> POWER_CONTROL_s1_agent:rdata_fifo_sink_error
