...
proc compose { } {
    ...
    add_connection clk_0.clk I2C_0.clock_sink clock

    add_connection clk_0.clk I2C_1.clock_sink clock

    add_connection clk_0.clk I2C_2.clock_sink clock

    add_connection clk_0.clk I2C_3.clock_sink clock

    add_connection clk_0.clk I2C_4.clock_sink clock

    add_connection clk_0.clk I2C_5.clock_sink clock

    add_connection clk_0.clk LED.clk clock

    add_connection clk_0.clk MYOControl_0.clock_sink clock

    add_connection clk_0.clk MYOControl_1.clock_sink clock

    add_connection clk_0.clk MYOControl_2.clock_sink clock

    add_connection clk_0.clk MYOQuad_0.clock clock

    add_connection clk_0.clk SWITCHES.clk clock

    add_connection clk_0.clk Uart_hand.clock clock

    add_connection clk_0.clk hps_0.h2f_lw_axi_clock clock

    add_connection clk_0.clk jtag_uart.clk clock

    add_connection clk_0.clk neopixel_0.clock_sink clock

    add_connection clk_0.clk pio_0.clk clock

    add_connection clk_0.clk pwm_0.clock_sink clock

    add_connection clk_0.clk sysid_qsys.clk clock

    add_connection clk_0.clk_reset I2C_0.reset reset

    add_connection clk_0.clk_reset I2C_1.reset reset

    add_connection clk_0.clk_reset I2C_2.reset reset

    add_connection clk_0.clk_reset I2C_3.reset reset

    add_connection clk_0.clk_reset I2C_4.reset reset

    add_connection clk_0.clk_reset I2C_5.reset reset

    add_connection clk_0.clk_reset LED.reset reset

    add_connection clk_0.clk_reset MYOControl_0.reset reset

    add_connection clk_0.clk_reset MYOControl_1.reset reset

    add_connection clk_0.clk_reset MYOControl_2.reset reset

    add_connection clk_0.clk_reset MYOQuad_0.reset reset

    add_connection clk_0.clk_reset SWITCHES.reset reset

    add_connection clk_0.clk_reset Uart_hand.reset_sink reset

    add_connection clk_0.clk_reset jtag_uart.reset reset

    add_connection clk_0.clk_reset neopixel_0.reset reset

    add_connection clk_0.clk_reset pio_0.reset reset

    add_connection clk_0.clk_reset pwm_0.reset reset
    ...
    add_connection hps_0.h2f_lw_axi_master I2C_0.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master I2C_1.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master I2C_2.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master I2C_3.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master I2C_4.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master I2C_5.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master LED.s1 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master MYOControl_0.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master MYOControl_1.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master MYOControl_2.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master MYOQuad_0.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master SWITCHES.s1 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master Uart_hand.avalon_slave avalon
    ...
    add_connection hps_0.h2f_lw_axi_master neopixel_0.avalon_slave_0 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master pio_0.s1 avalon
    ...
    add_connection hps_0.h2f_lw_axi_master pwm_0.avalon_slave_0 avalon
